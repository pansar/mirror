(function(){
      ...
      **/
      ...
      ShootingStar.prototype.addBeamPart = function( x, y ) {
        ...
        $( "#star"+name ).append( "<div id='haz"+this.n+"' class='haz' style='position:absolute; color:purple; width:10px; height:10px; font-weight:bold; font-size:"+this.options.starSize+"px'>·</div>" );
        if ( this.n > 1 ) $( "#haz" + ( this.n - 1 ) ).css( { color:"rgba(173,188,234,0.5)" } );
